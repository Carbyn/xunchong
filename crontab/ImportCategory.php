...
class ImportCategory {
    ...
    public static $categories = [
        ...
        ['cid' => 10002, 'pcid' => 100, 'name' => '医疗系列', 'icon' => ''],
        ['cid' => 10003, 'pcid' => 100, 'name' => '保健系列', 'icon' => ''],
        ['cid' => 10004, 'pcid' => 100, 'name' => '生活日用', 'icon' => ''],
        ['cid' => 10005, 'pcid' => 100, 'name' => '猫咪玩具', 'icon' => ''],
        ['cid' => 10006, 'pcid' => 100, 'name' => '猫咪美容', 'icon' => ''],
        ['cid' => 10007, 'pcid' => 100, 'name' => '猫砂猫厕', 'icon' => ''],

        ['cid' => 20000, 'pcid' => 200, 'name' => '干粮系列', 'icon' => ''],
        ['cid' => 20001, 'pcid' => 200, 'name' => '零食系列', 'icon' => ''],
        ['cid' => 20002, 'pcid' => 200, 'name' => '医疗系列', 'icon' => ''],
        ['cid' => 20003, 'pcid' => 200, 'name' => '保健系列', 'icon' => ''],
        ['cid' => 20004, 'pcid' => 200, 'name' => '生活日用', 'icon' => ''],
        ['cid' => 20005, 'pcid' => 200, 'name' => '狗狗美容', 'icon' => ''],
        ['cid' => 20006, 'pcid' => 200, 'name' => '狗狗玩具', 'icon' => ''],
        ['cid' => 20007, 'pcid' => 200, 'name' => '出行装备', 'icon' => ''],
        ...
        ['cid' => 1000101, 'pcid' => 10001, 'name' => '肉类零食', 'icon' => '/static/category/mao/rouleilingshi.jpg'],
        ['cid' => 1000102, 'pcid' => 10001, 'name' => '猫草薄荷', 'icon' => '/static/category/mao/maocaobohe.jpg'],
        ['cid' => 1000103, 'pcid' => 10001, 'name' => '休闲零食', 'icon' => '/static/category/mao/xiuxianlingshi.jpg'],

        ['cid' => 1000200, 'pcid' => 10002, 'name' => '皮肤治疗', 'icon' => '/static/category/mao/pifuzhiliao.jpg'],
        ['cid' => 1000201, 'pcid' => 10002, 'name' => '综合护理', 'icon' => '/static/category/mao/zonghehuli.jpg'],
        ['cid' => 1000202, 'pcid' => 10002, 'name' => '内外驱虫', 'icon' => '/static/category/mao/neiwaiquchong.jpg'],
        ['cid' => 1000203, 'pcid' => 10002, 'name' => '常备药品', 'icon' => '/static/category/mao/changbeiyaopin.jpg'],
        ...
        ['cid' => 1000500, 'pcid' => 10005, 'name' => '猫爬架', 'icon' => '/static/category/mao/maopajia.jpg'],
        ['cid' => 1000501, 'pcid' => 10005, 'name' => '猫抓板', 'icon' => '/static/category/mao/maozhuaban.jpg'],
        ['cid' => 1000502, 'pcid' => 10005, 'name' => '逗猫玩具', 'icon' => '/static/category/mao/doumaowanju.jpg'],

        ['cid' => 1000600, 'pcid' => 10006, 'name' => '洗护香波', 'icon' => '/static/category/mao/xihuxiangbo.jpg'],
        ...
        ['cid' => 1000703, 'pcid' => 10007, 'name' => '纸砂豆腐砂', 'icon' => '/static/category/mao/zhishadoufusha.jpg'],
        ['cid' => 1000704, 'pcid' => 10007, 'name' => '矿物猫砂', 'icon' => '/static/category/mao/kuangwumaosha.jpg'],
        ['cid' => 1000705, 'pcid' => 10007, 'name' => '猫砂除臭', 'icon' => '/static/category/mao/maoshachuchou.jpg'],
        ['cid' => 1000706, 'pcid' => 10007, 'name' => '猫咪厕所', 'icon' => '/static/category/mao/maomicesuo.jpg'],
        ['cid' => 1000707, 'pcid' => 10007, 'name' => '排便清洁', 'icon' => '/static/category/mao/paibianqingjie.jpg'],
        ...
        ['cid' => 2000201, 'pcid' => 20002, 'name' => '综合护理', 'icon' => '/static/category/gou/zonghehuli.jpg'],
        ['cid' => 2000202, 'pcid' => 20002, 'name' => '内外驱虫', 'icon' => '/static/category/gou/neiwaiquchong.jpg'],
        ['cid' => 2000203, 'pcid' => 20002, 'name' => '常备药品', 'icon' => '/static/category/gou/changbeiyaopin.jpg'],

        ['cid' => 2000300, 'pcid' => 20003, 'name' => '美毛护肤', 'icon' => '/static/category/gou/meimaohufu.jpg'],
        ['cid' => 2000301, 'pcid' => 20003, 'name' => '补钙健骨', 'icon' => '/static/category/gou/bugaijiangu.jpg'],
        ['cid' => 2000302, 'pcid' => 20003, 'name' => '肠胃调理', 'icon' => '/static/category/gou/changweitiaoli.jpg'],
        ['cid' => 2000302, 'pcid' => 20003, 'name' => '综合营养', 'icon' => '/static/category/gou/zongheyingyang.jpg'],

        ['cid' => 2000400, 'pcid' => 20004, 'name' => '狗狗餐具', 'icon' => '/static/category/gou/gougoucanju.jpg'],
        ['cid' => 2000401, 'pcid' => 20004, 'name' => '狗狗住所', 'icon' => '/static/category/gou/gougouzhusuo.jpg'],
        ['cid' => 2000402, 'pcid' => 20004, 'name' => '排便清洁', 'icon' => '/static/category/gou/paibianqingjie.jpg'],
        ...
        ['cid' => 2000702, 'pcid' => 20007, 'name' => '胸背套装', 'icon' => '/static/category/gou/xiongbeitaozhuang.jpg'],
        ['cid' => 2000703, 'pcid' => 20007, 'name' => '项圈狗牌', 'icon' => '/static/category/gou/xiangquangoupai.jpg'],
        ['cid' => 2000704, 'pcid' => 20007, 'name' => '外出辅助', 'icon' => '/static/category/gou/waichufuzhu.jpg'],
    ];
